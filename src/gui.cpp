...
//    drawParameters.add(drawBlurParameter.set("Draw Blur", false));
    ...
    secondSlidersContainer->add<ofxGuiIntInputField>(gradientY.set("Y", 600, 0, 2000));
    secondSlidersContainer->add<ofxGuiIntInputField>(gradientWidth.set("Width", 500, 0, 2000));
    secondSlidersContainer->add<ofxGuiIntInputField>(gradientHeight.set("Height", 1200, 0, 2000));
    secondSlidersContainer->add<ofxGuiIntInputField>(gradientZinitial.set("Initial Z position", 0, 0, 55));
    secondSlidersContainer->add<ofxGuiIntInputField>(gradientZfinal.set("Final Z position", 55, 0, 55));
    secondSlidersContainer->add<ofxGuiIntInputField>(gradientEinitial.set("Initial E position", 0, 0, 50));
    secondSlidersContainer->add<ofxGuiIntInputField>(gradientEfinal.set("Final E position", 50, 0, 50));
    secondSlidersContainer->add<ofxGuiIntInputField>(gradientFinitial.set("Initial speed", 1000, 0, 10000));
    secondSlidersContainer->add<ofxGuiIntInputField>(gradientFfinal.set("Final speed", 8000, 0, 10000));
    secondSlidersContainer->add<ofxGuiIntInputField>(gradientResolution.set("Resolution", 1, 0, 2000));
    secondSlidersContainer->add<ofxGuiIntInputField>(gradientDistance.set("Distance between lines", 5, 0, 2000));
    ...
    secondSlidersContainer->add<ofxGuiIntInputField>(travelSpeedParameter.set("Travel Speed", 5000, 0, 6000));
